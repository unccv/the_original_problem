...
| ------- | ------------- | --------------------------- | -------------------------- | -------------- |
| 0       | The Original Problem | [The Summer Vision Project](summer_vision_project.pdf) | - | - |
| 1       | Edges | [Machine perception of 3d solids **Abstact and Pages 25-27**](roberts_thesis.pdf)| - | - |
